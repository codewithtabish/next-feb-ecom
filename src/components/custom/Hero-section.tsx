...
const HeroSection = () => {
  ...
  <h1
    className="mt-8 max-w-sm bg-gradient-to-br  bg-clip-text text-center text-4xl font-extrabold  sm:max-w-4xl sm:text-6xl">
    Empowering Tomorrow with AI Today
  </h1>
  <span className="mt-8 max-w-lg text-center text-xl leading-relaxed  ">
  ...
  <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4">
    <Link href="https://example.com/new-feature"
      className="flex flex-row items-center justify-center gap-x-2 rounded-lg text-white px-10 py-3 text-white bg-primary">
    ...
    <Link href="#demo"
      className="flex flex-row items-center justify-center gap-x-2 rounded-lg border border-primary px-10 py-3 text-white">Learn
      More →
    </Link>
  </div>
</div>
